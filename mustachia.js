...
(function (exports) {
  ...
  function generateFullName(context) {
    if (typeof context._cache !== 'undefined') {
      var stack = [];
      while(typeof context.parent !== 'undefined') {
        stack.push(firstKey(context.view) + '.');//always add to end, trim the trailing one.
  ...
  Renderer.prototype._name = function (name, context, escape) {
    ...
    if (typeof context.parent !== 'undefined') {
      identifier = generateFullName(context);
      var attr = 'class';
    } else {
      identifier = firstKey(context.view);
      var attr = 'id';
    }
    
    if (escape) {
      return '<span '+attr+'="' + identifier + '">' + escapeHtml(string) + '</span>';
    }
